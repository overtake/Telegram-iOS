...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[466961494] = { return Api.ChannelParticipant.parse_channelParticipantWithRank($0) }
    ...
    dict[1627271828] = { return Api.DraftMessage.parse_draftMessageWithRichMessage($0) }
    ...
    dict[-433338016] = { return Api.KeyboardButton.parse_keyboardButtonCallbackWithStyle($0) }
    ...
    dict[-670292500] = { return Api.KeyboardButton.parse_keyboardButtonUrlWithStyle($0) }
    ...
    dict[-501814429] = { return Api.MessageMedia.parse_messageMediaPhotoWithVideo($0) }
    dict[1766936791] = { return Api.MessageMedia.parse_messageMediaPhoto($0) }
    dict[2000637542] = { return Api.MessageMedia.parse_messageMediaPollWithAttachedMedia($0) }
    ...
    dict[-1771164225] = { return Api.Poll.parse_pollWithHash($0) }
    dict[-15277366] = { return Api.PollAnswer.parse_pollAnswer($0) }
    dict[1266514026] = { return Api.PollAnswer.parse_pollAnswerWithMedia($0) }
    dict[997055186] = { return Api.PollAnswerVoters.parse_pollAnswerVoters($0) }
    dict[910500618] = { return Api.PollAnswerVoters.parse_pollAnswerVotersWithRecentVoters($0) }
    dict[2061444128] = { return Api.PollResults.parse_pollResults($0) }
    dict[-1166298786] = { return Api.PollResults.parse_pollResultsWithSolutionMedia($0) }
    ...
    dict[-699641301] = { return Api.Update.parse_updateMessagePollWithPeer($0) }
    ...
    dict[-1635468135] = { return Api.Update.parse_updateReadHistoryInboxWithTopMessage($0) }
    ...
    dict[706199388] = { return Api.Update.parse_updateUserTypingWithTopMessage($0) }
    ...
    dict[702447806] = { return Api.UserFull.parse_userFull($0) }
    ...
    dict[494135274] = { return Api.messages.Messages.parse_messagesWithTopics($0) }
    ...
    dict[1595959062] = { return Api.messages.Messages.parse_messagesSliceWithTopics($0) }
